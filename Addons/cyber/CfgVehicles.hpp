		...
		class ACE_Actions
		{
			class MainActions
			{
				...
				class OpenDatacenter
    			{
        			...
        			condition = "(_target getVariable [""ECF_Cyber_isActiv"", false]) && !(_target in (missionNamespace getVariable [""ecf_cyber_clients"", []]))";
        			distance = 4;
        			exceptions[] = {};
    			...
    			class CloseDatacenter
    			{
    				...
    				condition = "(_target in (missionNamespace getVariable [""ecf_cyber_clients"", []]))";
    				distance = 4;
    				exceptions[] = {};
    			...
    			class StartSystem
    			{
    				...
    				condition = "(_target getVariable [""ECF_Cyber_isActiv"", false]) && !(_target getVariable [""Ecy_Cyber_isStarted"", false]) && (_target in (missionNamespace getVariable [""ecf_cyber_clients"", []]))";
    				distance = 4;
    				exceptions[] = {};
